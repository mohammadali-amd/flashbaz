...
const ProductCategorySection = () => {
   return (
      <div className='lg:grid space-y-10 lg:grid-cols-5 items-center bg-gradient-to-tr from-white from-60% to-theme-color/70 to-90% border border-blue-200/70 rounded-3xl shadow-md w-fit gap-10 md:mx-auto py-10 lg:py-20 mx-4 my-28'>
         ...
         {categories.map((cat, index) => (
            ...
            ${index < categories.length - 1 && 'lg:border-l border-slate-400 md:pl-4'}
             px-10 md:px-auto space-y-3`}>
               <li className='font-semibold text-lg text-theme-color pb-2'>
