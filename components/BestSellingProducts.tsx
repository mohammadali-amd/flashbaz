            ...
            <CarouselLayout slidesPerView={5} navigation={true} spaceBetween={50}>
               {products?.map(product => (
                  <SwiperSlide key={product.id}>
                     <div key={product.id} className='space-y-8 border border-stone-200 shadow-lg hover:shadow-xl duration-200 shadow-gray-300 hover:shadow-gray-400 rounded-xl  my-10 py-8 px-10'>
